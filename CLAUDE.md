...
- `mediafile` has no POPM storage style, so storing an MP3/POPM rating needs
  `mutagen` directly; MP4 freeform ratings reuse `mediafile.MP4StorageStyle` and
  need no direct mutagen.
